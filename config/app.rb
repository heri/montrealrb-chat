...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'montrealrb.com'
  config.app_name = 'Montrealrb'
  config.mailer.from = 'Montrealrb <no-reply@montrealrb.com>'
  ...
  #
  config.app_secret = 'jTLzUsdcgt-6bpa1FOkVGYaolYRUy5YudzWJKcmFCLwQxNpSLFA5TGIJsxa4eBunVjA'
